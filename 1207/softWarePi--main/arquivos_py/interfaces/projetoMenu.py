...
"border-radius:3px;")
        ...
        self.gerar_relatorio = QPushButton(self.frame_3)
        self.gerar_relatorio.setObjectName(u"gerar_relatorio")
        self.gerar_relatorio.setGeometry(QRect(330, 270, 211, 61))
...
"}")
        ...
        self.btn_cadastro.setGeometry(QRect(90, 270, 211, 61))
...
"}")
        ...
        self.btn_devolucao.setGeometry(QRect(570, 270, 211, 61))
...
"Abaixo temos nossas intera\u00e7\u00f5es.", None))
        ...
        self.btn_cadastro.setText(QCoreApplication.translate("Menu", u"CADASTRO DE OBJETOS", None))
